...
import CategoryDistribution from './overview/CategoryDistribution'
  ...
  return (
    <div className=' flex-1 overflow-auto relative z-10`'>
        ...
        <main className=' max-w-7xl mx-auto py-6 px-4 lg:px-8'>
            <motion.div className=' grid grid-cols-1 gap-5 sm:grid-cols-2 mb-8 lg:grid-cols-4'
            ...
            <div className='grid grid-col-1 gap-3 lg:grid-cols-2 mb-4'>
              <SalesOverviewChart/>
