			...
			<div className='flex justify-between items-center mb-6'>
				...
				<div className='relative'>
					<input
						...
						className='bg-gray-700 text-white placeholder-gray-400 rounded-lg pl-10 pr-4 py-2 focus:outline-none max-sm:w-32 max-sm:px-1 focus:ring-2 focus:ring-blue-500'
						value={searchTerm}
